...
* GettingStarted
*/
    class GettingStarted extends \Kaur\View
    {
        /**
* __construct
*
...
*
* @access public
* @param \Kaur\View Contains the child view to render as the main content page.
* @return mixed
*/
        public function content(\Kaur\View $view = null)
        {
            if( null === $view ) {
