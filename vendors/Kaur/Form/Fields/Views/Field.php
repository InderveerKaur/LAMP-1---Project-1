...
*/
class Field extends \Kaur\HTML\Views\Element
{
...
*/
public function __construct($title = '', \Kaur\HTML\Views\Element $element = null)
{
parent::__construct('div');

$this->_label = new \Kaur\HTML\Views\Label($title);
...
*/
final public function addChild(\Kaur\HTML\Views\Element $element)
{
...
*/
final public function removeChild(\Kaur\HTML\Views\Element $element)
{
throw new \Exception('Field elements cannot have added children in this implementation other then the label and field type.');
}
